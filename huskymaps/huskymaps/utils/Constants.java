...
public class Constants {
    ...
    public static final String BASE_DIR_PATH = "./data/"; //FILE-REFERENCE-HERE

    /**
     * The OSM XML file path. Downloaded from <a href="http://download.bbbike.org/osm/">here</a>
     * using custom region selection.
     */
    public static final String LARGE_OSM_DB_PATH = BASE_DIR_PATH + "seattle.osm.gz";
    ...
    public static final Color ROUTE_STROKE_COLOR2 = new Color(200, 0, 0);
    ...
    public static List<Long> ROUTE_LIST2 = new LinkedList<>();
