...
public class LinkedIntList {
    ...
    public static void firstToLast(LinkedIntList L) {
        if (L == null) {
            ...
            System.out.println("Len of 1");
        } else {
            ListNode temp  = L.front;
            int tdata = L.front.data;
            while (temp.next != null){
                temp = temp.next;
            }

            temp.next = new ListNode(tdata,null);
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        if (A.front == null & B.front == null) {
            ...
            ListNode newTempNode = temp.front = new ListNode(B.front.data, null);
            ListNode bTempNode = B.front;
            while (bTempNode.next != null){
                newTempNode = newTempNode.next = new ListNode(bTempNode.next.data, null);
            ...
            ListNode newTempNode = temp.front = new ListNode(A.front.data, null);
            ListNode aTempNode = A.front;
            while (aTempNode.next != null){
                newTempNode = newTempNode.next = new ListNode(aTempNode.next.data, null);
            ...
            LinkedIntList temp = concatenated(A, new LinkedIntList());
            extend(temp, concatenated(B, new LinkedIntList()));
            return temp;
        }
