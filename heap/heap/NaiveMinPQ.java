...
public class NaiveMinPQ<T> implements ExtrinsicMinPQ<T> {
    ...
    public NaiveMinPQ<T> getCopy(){
        NaiveMinPQ<T> temp = new NaiveMinPQ<>();
        temp.items = (ArrayList<NaiveMinPQ<T>.PriorityNode>)this.items.clone();
        return temp;
    }
    public Object[] getArray(){
        NaiveMinPQ<T> temp = this.getCopy();
