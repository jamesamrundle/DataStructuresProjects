...
public class ArrayHeapCopy<T> implements ExtrinsicMinPQ<T> {
    ArrayList<PriorityNode> data ;
    HashMap<T,Double> datamap = new HashMap<>();

    public ArrayHeapCopy() {
...
//        if( data.get(index).item.equals(item)) return data.get(index);
        ...
        T rightItem;
            ...
            if( rightInd < data.size() ) rightChild = data.get(rightInd);
    ...
    class PriorityNode implements Comparable<ArrayHeapCopy.PriorityNode> {
        private T item;
        ...
        @Override
        public int compareTo(ArrayHeapCopy.PriorityNode other) {
            if (other == null) {
                return -1;
            }
        ...
        public boolean equals(Object o) {
            if (o == null || o.getClass() != this.getClass()) {
                ...
                return ((ArrayHeapCopy.PriorityNode) o).getItem().equals(getItem());
            }
        }
    ...
    public Object[] getOrderedArray(){
        ArrayHeapCopy<T> temp = new ArrayHeapCopy<>();
